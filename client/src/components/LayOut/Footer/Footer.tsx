      ...
      <div className="container mx-auto px-6 pt-10 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-1">
            <h2 className="text-2xl font-bold mb-4 font-cursive bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-300">
              S BEATS
            </h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/ContactUs" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                  </svg>
                  Contact Us
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
                <span className="text-gray-300">123 Music Avenue, Rhythm City, USA</span>
              </p>
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span className="text-gray-300">info@nkbeats.com</span>
              </p>
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6">
              ...
              <div className="flex mt-2">
                <input type="email" placeholder="Your email" className="px-4 py-2 bg-gray-800 text-gray-200 rounded-l-md focus:outline-none focus:ring-1 focus:ring-indigo-400 w-full" />
                <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 rounded-r-md transition-colors duration-300">
